...
<div class="adminSayfa">
	...
	<table style="margin-right: 152px; class="table table-striped" id="contentTable">
	<thead>
		<tr>
			<th>Başlık</th>
			<th>İçerik</th>
	...
	<tbody>
		<?php 
			$userList = $db->query("SELECT com.Id, com.Topic, com.Text, com.CreationDate, u.FirstName, u.LastName FROM comments com INNER JOIN users u ON com.Owner = u.Id WHERE com.Confirm = 0");
		...
		<tr>
			...
			<td>
				<button class="btn btn-success btn-xs confirmComment" id="<?php echo $contentId; ?>">Yayınla</button> | 
...
$(document).ready(function(e){
	...
	$(document).on('click','.confirmComment',function(){
		...
		$.ajax({
					url:"confirmComment.php",
					type:"post",
					data:{edit_id:edit_id},
					success:function(data){
						alert("Yorum Onaylandı ve Yayınlandı.");
						location.reload();
					}
				});
